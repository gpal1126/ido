...
function singleType(json, i){
	...
	for(j in json.reply){
		...
		//중질문 답변            
		var surveyReplyHtml = 
		'<div class="contsDiv'+(i+1)+' img" id="contsDiv'+(i+1)+'_'+(j+1)+'" name="contsDiv'+(i+1)+'_s'+(j+1)+'"><br><br><br>';
		...
		switch(json.reply.length){
			/*case 2 :
				...
				$('#surveyForm'+(i+1)+' .conts_div').css({'padding-left':'120px'});
			...
			case 5 :
				console.log('555555');
				/*$('#surveyForm'+(i+1)+' .conts_div').css({'padding-left':'0px'});*/
